    ...
    children: [
      ...
      new Table({
        ...
        rows: [
          ...
          tr([2800, 2500, 4206], ["pages/consent/consent", "C端", "知情同意书签署（完整阅读确认 + 手写签名）"]),
      ...
      P("顾客扫小程序码 -> checkin页 -> 显示预约信息 -> 点击[阅读并签署] -> consent页（操作师引导阅读）-> 滑到底 -> 勾选完整阅读 -> 手写签名 -> 确认签署 -> 返回checkin页 -> 显示全屏欢迎页[欢迎体验冰美肌]", {color: "5B21B6", size: 20}),
      BR(),
