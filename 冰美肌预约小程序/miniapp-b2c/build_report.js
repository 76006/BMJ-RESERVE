...
const t7 = tbl([800, 2800, 3200, 3040], [
  ...
  ["4","确认并签名","勾选「我已完整阅读并理解」→手写签名→确认签署→写入booking→navigateBack",[BT('高'),"保存签名图片与签署时间"]],
...
const t11 = tbl([2400, 2400, 2400, 2640], [
  ...
  ["操作师填写（黄）","_immediateSatisfaction/_comfortSatisfaction/_productFeedback/_day30/90回访","detail页编辑模式","bookings集合"],
  ["照片","_immediatePhotos/_day30Photos/_day90Photos","体验后立即/30天/90天照片上传",[BT('低'),"已使用云存储fileID"]],
